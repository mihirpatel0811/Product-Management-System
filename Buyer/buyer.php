...
$countQuery = "SELECT COUNT(*) AS total FROM buyers WHERE buyer_name LIKE CONCAT('%', ?, '%')";
...
// Fetch buyers including owner_name (Ordered by newest first)
$query = "SELECT * FROM buyers WHERE buyer_name LIKE CONCAT('%', ?, '%') ORDER BY id DESC LIMIT ?, ?";
...
<head>
    ...
    <link rel="stylesheet" href="../CSS/Main/Buyer_dashborad.css">
    <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
    <style>
        .navbar a.active1 { color: #0ef; }
    </style>
</head>
<body>
    <header class="header">
        ...
        <main class="main">
            ...
            <div class="search-bar">
                <form action="buyer.php" method="get">
                    ...
                    <a href="create.php"><i class="bx bx-plus"></i> Add Buyer Details</a>
                </form>
            </div>
            <table>
                <thead>
                ...
                <tbody>
                    <?php $i = $start + 1; while ($row = $result->fetch_assoc()) : ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($row['buyer_phone_no']); ?></td>
                            ...
                            <td>
                                ...
                                <a href="delete.php?id=<?php echo $row['id']; ?>" class="delete" onclick="return confirm('Are you sure you want to delete this buyer?')">
