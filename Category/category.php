...
$countQuery = "SELECT COUNT(*) AS total FROM categories WHERE category_name LIKE CONCAT('%', ?, '%')";
...
// Fetch categories with pagination (ordered by newest first)
$query = "SELECT * FROM categories WHERE category_name LIKE CONCAT('%', ?, '%') ORDER BY id DESC LIMIT ?, ?";
        ...
        <main class="main">
            ...
            <div class="search-bar">
                <form action="category.php" method="get">
                    ...
                    <a href="create.php"><i class="bx bx-plus"></i> Add Category</a>
                </form>
            </div>
            <table>
                <thead>
                    ...
                    while ($row = $result->fetch_assoc()) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="delete.php?id=<?php echo $row['id']; ?>" class="delete" onclick="return confirm('Are you sure you want to delete this category?')">
